    ...
    public class CameraHelper : INotifyPropertyChanged
    {
        ...
        public async Task InitializeCameraAsync()
        {
            if (MediaCapture == null)
            {
                ...
                //negdje zabiljeziti statuse kad kamera ne radi ili varijabla ili exception, sta je vise
                //pogodno
               ...
               cameraDevice.Id
                ...
                if (_isInitialized)
                {
                    // Kako baratati sa naopakim kamerama, da li prednju ili zadnju kameru na mobitelu treba
                    // flipati
